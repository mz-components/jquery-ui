...
(function (factory) {
    ...
    module.exports = factory(require('jquery'), require('./core'), require('./widget'), require('./button'), require('./draggable'), require('./mouse'), require('./position'), require('./resizable')) || module.exports;;
}(function ($) {
    $.widget('ui.dialog', {
        version: '@VERSION',
        options: {
