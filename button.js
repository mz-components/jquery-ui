...
(function (factory) {
    ...
    module.exports = factory(require('jquery'), require('./core'), require('./widget')) || module.exports;;
}(function ($) {
...
.on('keyup' + this.eventNamespace + ' blur' + this.eventNamespace, function () {
        ...
        _destroy: function () {
            ...
            this.buttonElement.removeClass(baseClasses + ' ui-state-active ' + typeClasses).removeAttr('role aria-pressed').html(this.buttonElement.find('.ui-button-text').html());
            if (!this.hasTitle) {
